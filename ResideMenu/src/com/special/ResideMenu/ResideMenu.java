...
public class ResideMenu extends FrameLayout {
    ...
    public void closeMenu() {
        ...
        AnimatorSet alpha_menuClose = buildCloseMenuAnimation(scrollViewMenu, 0.0f);
        scaleUp_activity.addListener(animationListener);
        scaleUp_activity.playTogether(scaleUp_shadow);
        scaleUp_activity.playTogether(alpha_menuClose);
    ...
    private AnimatorSet buildCloseMenuAnimation(View target, float alpha) {
